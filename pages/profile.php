                    ...
                    <div class="forum_topic_list">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="profile_info">
                                    ...
                                    <ul class="navbar-nav info_list">
                                        ...
                                        <li><span>Website: </span><a href="#">https://html.spider-themes.com/Docy/</a></li>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="input-group search_forum">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" id="button-addon2"><i class="icon_search"></i></button>
                                    </div>
                                </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <form action="#" class="cate-search-form">
                                                            <input type="text" placeholder="Search users" id="search_field2">
                                                        </form>
                                                        <div class="all_users scroll">
                                                            <a class="dropdown-item" href="#"><img src="img/forum/filter-user-1.png" alt="">
                                                                Donny
                                                                Peters</a>
                                            ...
                                            <li>
                                                <div class="dropdown right_dir">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                                        ...
                                                        <form action="#" class="cate-search-form">
                                                            <input type="text" placeholder="Search users" id="search_field1">
                                                        </form>
                                                        <div class="all_users scroll">
                                            ...
                                            <li>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        <h3 class="title">Filter by author</h3>
                                                        <form action="#" class="cate-search-form">
                                                            <input type="text" placeholder="Search users" id="search_field3">
                                                        </form>
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="t_title">
                                                            ...
                                                            <a class="docbuzz greenl" href="%24.html">Docs</a>
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="right">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination">
                                                ...
                                                <li class="page-item"><a class="page-link" href="#"><i class="arrow_carrot-right"></i></a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade " id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <div class="input-group search_forum">
                                    <input type="text" class="form-control" placeholder="Your work email" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    <div class="input-group-append">
                                        <button class="btn btn-outline-secondary" type="button" id="button-addon3"><i class="icon_search"></i></button>
                                    </div>
                                </div>
                                <h2>Forum Topics Started</h2>
                                        ...
                                        <ul class="nav right">
                                            <li>
                                                <div class="dropdown list_sirt">
                                                    ...
                                                    <div class="dropdown-menu short-by" aria-labelledby="dropdownMenuButton5">
                                                        <a class="dropdown-item active-short" href="#0">Oldest</a>
